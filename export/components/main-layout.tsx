...
export const MainLayout: React.FC<MainLayoutProps> = ({
  ...
  const modules = [
    ...
    { id: "differentiation", label: "Differentiation", icon: "lucide:function-square" },
    { id: "integration", label: "Integration", icon: "lucide:sigma" },
    { id: "simplification", label: "Simplification", icon: "lucide:equal" },
    { id: "powers-roots", label: "Powers & Roots", icon: "lucide:square-root" },
                ...
                <li key={module.id}>
                  <Button
                    ...
                    className={`justify-start ${
                      activeModule === module.id ? "" : "bg-transparent"
                    }`}
                    startContent={<Icon icon={module.icon} width={20} />}
