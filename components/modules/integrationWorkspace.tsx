...
import { IntegrationProblem, IntegrationStep } from '@/types/integration';
...
export const IntegrationWorkspace: React.FC<IntegrationWorkspaceProps> = ({
    problem,
    currentStep,
    highlightMode,
}) => {
    ...
    return (
        <div className="space-y-6">
            ...
            <Card>
                ...
                <CardBody>
                    <div className="text-center">
                        <BlockMath math={`\\int ${problem.function} \\, dx`} />
                    </div>
                </CardBody>
            </Card>
                ...
                {currentStep >= problem.steps.length && (
                    <Card className="bg-success/10 border-success/20">
                        ...
                        <CardBody>
                            <div className="text-center">
                                <BlockMath
                                    math={`\\int ${problem.function} \\, dx = ${problem.integral} + C`}
                                />
                            </div>
                        </CardBody>
                    </Card>
            ...
            <Card className="bg-warning/10 border-warning/20">
                ...
                <CardBody>
                    <div className="text-xs space-y-1">
                        ...
                        <p>
                            • Check your answer by differentiating it to get
                            back the original function
                        </p>
                        <p>
                            • Look for patterns that match standard integration
                            rules
                        </p>
                    </div>
                </CardBody>
