...
interface SimplificationWorkspaceProps {
    problem: SimplificationProblem | null;
    currentStep: number;
    highlightMode: boolean;
}

export const SimplificationWorkspace: React.FC<SimplificationWorkspaceProps> = ({
    problem,
    currentStep,
    highlightMode,
}) => {
            ...
            <div className="flex items-center justify-center h-96">
                <div className="text-center">
                    <p className="text-default-500 text-lg mb-2">
                        No simplification problem loaded
                    </p>
    ...
    const renderStep = (step: SimplificationStep, index: number) => {
            ...
            <div className="space-y-4">
                ...
                {currentStep >= problem.steps.length && (
                    <Card className="bg-success/10 border-success/20">
                        ...
                        <CardBody>
                            <div className="text-center">
                                <BlockMath math={problem.simplified} />
                            </div>
                        </CardBody>
                    </Card>
                )}
